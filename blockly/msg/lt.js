...
(function (root, factory) {
  ...
  Blockly.Msg["COLLAPSED_WARNINGS_WARNING"] =
    "Suskleistuose blokuose yra įspėjimų.";
  ...
  Blockly.Msg["CONTROLS_FOR_TITLE"] =
    "kartok, kai %1 kinta nuo %2 iki %3 po %4";
  ...
  Blockly.Msg["LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FIRST"] =
    "Pašalina ir grąžina pirmąjį sąrašo objektą.";
  Blockly.Msg["LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM"] =
    "Pašalina ir grąžina objektą nurodytoje sąrašo pozicijoje.";
  Blockly.Msg["LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_LAST"] =
    "Pašalina ir grąžina paskutinį sąrašo objektą.";
  Blockly.Msg["LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_RANDOM"] =
    "Pašalina ir grąžina atsitiktinį sąrašo objektą.";
  ...
  Blockly.Msg["LISTS_ISEMPTY_TOOLTIP"] =
    "Grąžina „true“, jeigu sąrašas tuščias.";
  ...
  Blockly.Msg["LISTS_SET_INDEX_TOOLTIP_INSERT_LAST"] =
    "Pridėkite objektą prie sąrašo pabaigos.";
  ...
  Blockly.Msg["LISTS_SET_INDEX_TOOLTIP_SET_FIRST"] =
    "Nustato pirmąjį sąrašo objektą.";
  Blockly.Msg["LISTS_SET_INDEX_TOOLTIP_SET_FROM"] =
    "Nustato objektą nurodytoje sąrašo vietoje.";
  Blockly.Msg["LISTS_SET_INDEX_TOOLTIP_SET_LAST"] =
    "Nustato paskutinį sąrašo objektą.";
  Blockly.Msg["LISTS_SET_INDEX_TOOLTIP_SET_RANDOM"] =
    "Sąraše nustato atsitiktinį objektą.";
  ...
  Blockly.Msg["LISTS_SORT_TYPE_IGNORECASE"] =
    "abecėlės, ignoruoti raidžių dydį";
  ...
  Blockly.Msg["LOGIC_COMPARE_TOOLTIP_EQ"] =
    "Tenkinama, jei abu reiškiniai lygūs.";
  ...
  Blockly.Msg["MATH_ARITHMETIC_TOOLTIP_DIVIDE"] =
    "Grąžina dviejų skaičių dalmenį.";
  Blockly.Msg["MATH_ARITHMETIC_TOOLTIP_MINUS"] =
    "Grąžina dviejų skaičių skirtumą.";
  ...
  Blockly.Msg["MATH_MODULO_TOOLTIP"] =
    "Grįžti likučiu nuo dviejų skaičių dalybos.";
  ...
  Blockly.Msg["MATH_ONLIST_OPERATOR_RANDOM"] =
    "atsitiktinis elementas iš sąrašo";
  ...
  Blockly.Msg["MATH_ONLIST_TOOLTIP_MAX"] =
    "Grįžti didžiausiu skaičiumi sąraše.";
  ...
  Blockly.Msg["MATH_RANDOM_INT_TITLE"] =
    "atsitiktinis sveikas sk. nuo %1 iki %2";
  ...
  Blockly.Msg["MATH_ROUND_HELPURL"] =
    "https://lt.wikipedia.org/wiki/Apvalinimas";
  ...
  Blockly.Msg["MATH_TRIG_TOOLTIP_COS"] =
    "Grąžinti laipsnio kosinusą (ne radiano).";
  Blockly.Msg["MATH_TRIG_TOOLTIP_SIN"] =
    "Grąžinti laipsnio sinusą (ne radiano).";
  Blockly.Msg["MATH_TRIG_TOOLTIP_TAN"] =
    "Grąžinti laipsnio tangentą (ne radiano).";
  ...
  Blockly.Msg["RENAME_VARIABLE_TITLE"] =
    "Pervadinti visus '%1' kintamuosius į:";
  ...
  Blockly.Msg["TEXT_CHANGECASE_TOOLTIP"] =
    "Kitu atvėju, grąžina teksto kopiją.";
  ...
  Blockly.Msg["TEXT_INDEXOF_OPERATOR_LAST"] =
    "rask,kur paskutinį kartą paminėta";
  ...
  Blockly.Msg["TEXT_PROMPT_TOOLTIP_NUMBER"] =
    "Prašyti vartotoją įvesti skaičių.";
  ...
  Blockly.Msg["VARIABLES_SET_TOOLTIP"] =
    "Nustato, kad šis kintamasis būtų lygus įvesties vertei.";
