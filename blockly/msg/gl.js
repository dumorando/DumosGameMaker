...
(function (root, factory) {
  ...
  Blockly.Msg["CANNOT_DELETE_VARIABLE_PROCEDURE"] =
    "Non se pode eliminar a variable \"%1\" porque forma parte da definición da función '%2'";
  ...
  Blockly.Msg["COLLAPSED_WARNINGS_WARNING"] =
    "Os bloques contraídos conteñen avisos.";
  ...
  Blockly.Msg["COLOUR_BLEND_TOOLTIP"] =
    "Mestura dúas cores coa proporción indicada (0,0 - 1,0).";
  ...
  Blockly.Msg["COLOUR_RGB_TOOLTIP"] =
    "Crea unha cor coa cantidade especificada de vermello, verde e azul. Todos os valores deben estar entre 0 e 100.";
  ...
  Blockly.Msg["CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE"] =
    "continuar coa seguinte iteración do bucle";
  Blockly.Msg["CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK"] =
    "Saír do bucle interior.";
  Blockly.Msg["CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE"] =
    "Saltar o resto do bucle e continuar coa seguinte iteración.";
  Blockly.Msg["CONTROLS_FLOW_STATEMENTS_WARNING"] =
    "Aviso: Este bloque só se pode usar dentro dun bucle.";
  ...
  Blockly.Msg["CONTROLS_FOREACH_TOOLTIP"] =
    'Para cada elemento dunha lista, establece o elemento na variable "%1" e logo executa algunhas instrucións.';
  ...
  Blockly.Msg["CONTROLS_FOR_TITLE"] =
    "contar con %1 desde %2 ata %3 en incrementos de %4";
  Blockly.Msg["CONTROLS_FOR_TOOLTIP"] =
    'Fai que a variable "%1" tome os valores desde o número inicial ata o número final dentro do intervalo especificado e executa os bloques especificados.';
  Blockly.Msg["CONTROLS_IF_ELSEIF_TOOLTIP"] =
    'Engade unha condición ao bloque "se".';
  Blockly.Msg["CONTROLS_IF_ELSE_TOOLTIP"] =
    'Engade unha condición final e predeterminada ao bloque "se".';
  ...
  Blockly.Msg["CONTROLS_IF_IF_TOOLTIP"] =
    'Engade, elimina ou reordena as seccións para reconfigurar este bloque "se".';
  ...
  Blockly.Msg["CONTROLS_IF_TOOLTIP_1"] =
    "Se un valor é verdadeiro, executa algunhas instrucións.";
  Blockly.Msg["CONTROLS_IF_TOOLTIP_2"] =
    "Se un valor é verdadeiro, executa o primeiro bloque de instrucións. En caso contrario, executa o segundo bloque de instrucións.";
  Blockly.Msg["CONTROLS_IF_TOOLTIP_3"] =
    "Se o primeiro valor é verdadeiro, executa o primeiro bloque de instrucións. En caso contrario, se o segundo valor é verdadeiro, executa o segundo bloque de instrucións.";
  Blockly.Msg["CONTROLS_IF_TOOLTIP_4"] =
    "Se o primeiro valor é verdadeiro, executa o primeiro bloque de instrucións. En caso contrario, se o segundo valor é verdadeiro, executa o segundo bloque de instrucións. Se ningún valor é verdadeiro, executa o último bloque de instrucións.";
  ...
  Blockly.Msg["CONTROLS_REPEAT_TOOLTIP"] =
    "Executa algunhas instrucións varias veces.";
  ...
  Blockly.Msg["CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL"] =
    "Namentres un valor é falso, executa algunhas instrucións.";
  Blockly.Msg["CONTROLS_WHILEUNTIL_TOOLTIP_WHILE"] =
    "Namentres un valor é verdadeiro, executa algunhas instrucións.";
  ...
  Blockly.Msg["DELETE_VARIABLE_CONFIRMATION"] =
    "Queres eliminar %1 usos da variable '%2'?";
  ...
  Blockly.Msg["LISTS_CREATE_EMPTY_TOOLTIP"] =
    "Devolve unha lista, de lonxitude 0, que non contén rexistros de datos";
  Blockly.Msg["LISTS_CREATE_WITH_CONTAINER_TITLE_ADD"] = "lista";
  Blockly.Msg["LISTS_CREATE_WITH_CONTAINER_TOOLTIP"] =
    "Engade, elimina ou reordena as seccións para reconfigurar este bloque de lista.";
  ...
  Blockly.Msg["LISTS_CREATE_WITH_TOOLTIP"] =
    "Crea unha lista con calquera número de elementos.";
  ...
  Blockly.Msg["LISTS_GET_INDEX_TOOLTIP_GET_FIRST"] =
    "Devolve o primeiro elemento dunha lista.";
  Blockly.Msg["LISTS_GET_INDEX_TOOLTIP_GET_FROM"] =
    "Devolve o elemento na posición especificada dunha lista.";
  Blockly.Msg["LISTS_GET_INDEX_TOOLTIP_GET_LAST"] =
    "Devolve o derradeiro elemento dunha lista.";
  ...
  Blockly.Msg["LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM"] =
    "Elimina e devolve o elemento na posición especificada dunha lista.";
  Blockly.Msg["LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_LAST"] =
    "Elimina e devolve o derradeiro elemento dunha lista.";
  ...
  Blockly.Msg["LISTS_GET_INDEX_TOOLTIP_REMOVE_LAST"] =
    "Elimina o derradeiro elemento dunha lista.";
  ...
  Blockly.Msg["LISTS_GET_SUBLIST_START_FIRST"] =
    "obter a sublista desde o primeiro";
  Blockly.Msg["LISTS_GET_SUBLIST_START_FROM_END"] =
    "obter a sublista desde # desde o final";
  Blockly.Msg["LISTS_GET_SUBLIST_START_FROM_START"] =
    "obter a sublista desde #";
  Blockly.Msg["LISTS_GET_SUBLIST_TAIL"] = ""; // untranslated
  Blockly.Msg["LISTS_GET_SUBLIST_TOOLTIP"] =
    "Crea unha copia da parte especificada dunha lista.";
  ...
  Blockly.Msg["LISTS_INDEX_OF_FIRST"] =
    "atopar a primeira aparición do elemento";
  ...
  Blockly.Msg["LISTS_INDEX_OF_LAST"] =
    "atopar a derradeira aparición do elemento";
  Blockly.Msg["LISTS_INDEX_OF_TOOLTIP"] =
    "Devolve o índice da primeira/derradeira aparición do primeiro elemento na lista. Devolve %1 se non se atopa o elemento.";
  ...
  Blockly.Msg["LISTS_REPEAT_TOOLTIP"] =
    "Crea unha lista composta polo valor indicado repetido o número especificado de veces.";
  ...
  Blockly.Msg["LISTS_SET_INDEX_TOOLTIP_INSERT_FIRST"] =
    "Insire o elemento ao comezo dunha lista.";
  Blockly.Msg["LISTS_SET_INDEX_TOOLTIP_INSERT_FROM"] =
    "Insire o elemento na posición especificada dunha lista.";
  Blockly.Msg["LISTS_SET_INDEX_TOOLTIP_INSERT_LAST"] =
    "Engade o elemento ao final dunha lista.";
  Blockly.Msg["LISTS_SET_INDEX_TOOLTIP_INSERT_RANDOM"] =
    "Insire o elemento de forma aleatoria nunha lista.";
  Blockly.Msg["LISTS_SET_INDEX_TOOLTIP_SET_FIRST"] =
    "Define o primeiro elemento dunha lista.";
  Blockly.Msg["LISTS_SET_INDEX_TOOLTIP_SET_FROM"] =
    "Define o elemento na posición especificada dunha lista.";
  Blockly.Msg["LISTS_SET_INDEX_TOOLTIP_SET_LAST"] =
    "Define o derradeiro elemento dunha lista.";
  Blockly.Msg["LISTS_SET_INDEX_TOOLTIP_SET_RANDOM"] =
    "Define un elemento aleatorio nunha lista.";
  ...
  Blockly.Msg["LISTS_SORT_TYPE_IGNORECASE"] =
    "alfabética, ignorar as maiúsculas e minúsculas";
  ...
  Blockly.Msg["LISTS_SPLIT_LIST_FROM_TEXT"] =
    "elaborar unha lista a partir do texto";
  Blockly.Msg["LISTS_SPLIT_TEXT_FROM_LIST"] =
    "elaborar un texto a partir da lista";
  Blockly.Msg["LISTS_SPLIT_TOOLTIP_JOIN"] =
    "Une unha lista de textos nun texto, separados por un delimitador.";
  Blockly.Msg["LISTS_SPLIT_TOOLTIP_SPLIT"] =
    "Divide o texto nunha lista de textos, rompéndoo en cada delimitador.";
  ...
  Blockly.Msg["LOGIC_COMPARE_TOOLTIP_EQ"] =
    "Devolve verdadeiro se as dúas entradas son iguais entre si.";
  Blockly.Msg["LOGIC_COMPARE_TOOLTIP_GT"] =
    "Devolve verdadeiro se a primeira entrada é maior que a segunda entrada.";
  Blockly.Msg["LOGIC_COMPARE_TOOLTIP_GTE"] =
    "Devolve verdadeiro se a primeira entrada é maior ou igual que a segunda entrada.";
  Blockly.Msg["LOGIC_COMPARE_TOOLTIP_LT"] =
    "Devolve verdadeiro se a primeira entrada é menor que a segunda entrada.";
  Blockly.Msg["LOGIC_COMPARE_TOOLTIP_LTE"] =
    "Devolve verdadeiro se a primeira entrada é menor ou igual que a segunda entrada.";
  Blockly.Msg["LOGIC_COMPARE_TOOLTIP_NEQ"] =
    "Devolve verdadeiro se as dúas entradas non son iguais entre si.";
  ...
  Blockly.Msg["LOGIC_OPERATION_TOOLTIP_AND"] =
    "Devolve verdadeiro se as dúas entradas son verdadeiras.";
  ...
  Blockly.Msg["LOGIC_TERNARY_TOOLTIP"] =
    'Comproba a condición que hai en "condición". Se a condición é verdadeira, devolve o valor de "se é verdadeiro"; en caso contrario, devolve o valor de "se é falso".';
  ...
  Blockly.Msg["MATH_ARITHMETIC_TOOLTIP_ADD"] =
    "Devolve a suma de dous números.";
  Blockly.Msg["MATH_ARITHMETIC_TOOLTIP_DIVIDE"] =
    "Devolve o cociente da división de dous números.";
  Blockly.Msg["MATH_ARITHMETIC_TOOLTIP_MINUS"] =
    "Devolve a diferenza de dous números.";
  Blockly.Msg["MATH_ARITHMETIC_TOOLTIP_MULTIPLY"] =
    "Devolve o produto de dous números.";
  ...
  Blockly.Msg["MATH_ATAN2_TOOLTIP"] =
    "Devolve o arcotanxente do punto (X, Y) en graos de -180 a 180.";
  ...
  Blockly.Msg["MATH_CONSTANT_TOOLTIP"] =
    "Devolve unha das constantes comúns: π (3.141…), e (2.718…), φ (1.618…), sqrt(2) (1.414…), sqrt(½) (0.707…) ou ∞ (infinito).";
  ...
  Blockly.Msg["MATH_CONSTRAIN_TOOLTIP"] =
    "Restrinxir un número para que estea entre os límites especificados (incluídos).";
  ...
  Blockly.Msg["MATH_IS_TOOLTIP"] =
    "Verifica se un número é par, impar, primo, enteiro, positivo, negativo ou se é divisíbel por outro número. Devolve verdadeiro ou falso.";
  ...
  Blockly.Msg["MATH_MODULO_TOOLTIP"] =
    "Devolve o resto de dividir os dous números.";
  ...
  Blockly.Msg["MATH_ONLIST_TOOLTIP_AVERAGE"] =
    "Devolve a media aritmética dos valores numéricos da lista.";
  Blockly.Msg["MATH_ONLIST_TOOLTIP_MAX"] =
    "Devolve o número máis grande da lista.";
  ...
  Blockly.Msg["MATH_ONLIST_TOOLTIP_MODE"] =
    "Devolve a lista do(s) elemento(s) máis comúns na lista.";
  Blockly.Msg["MATH_ONLIST_TOOLTIP_RANDOM"] =
    "Devolve un elemento aleatorio da lista.";
  Blockly.Msg["MATH_ONLIST_TOOLTIP_STD_DEV"] =
    "Devolve a desviación típica da lista.";
  Blockly.Msg["MATH_ONLIST_TOOLTIP_SUM"] =
    "Devolve a suma de tódolos números da lista.";
  ...
  Blockly.Msg["MATH_RANDOM_FLOAT_TOOLTIP"] =
    "Devolve unha fracción aleatoria entre 0,0 (incluído) e 1,0 (excluído).";
  ...
  Blockly.Msg["MATH_RANDOM_INT_TOOLTIP"] =
    "Devolve un número enteiro aleatorio entre os dous límites especificados (incluídos).";
  Blockly.Msg["MATH_ROUND_HELPURL"] =
    "https://gl.wikipedia.org/wiki/Arredondamento";
  ...
  Blockly.Msg["MATH_ROUND_TOOLTIP"] =
    "Arredonda un número cara a arriba ou cara a abaixo.";
  Blockly.Msg["MATH_SINGLE_HELPURL"] =
    "https://gl.wikipedia.org/wiki/Raíz_cadrada";
  ...
  Blockly.Msg["MATH_SINGLE_TOOLTIP_ROOT"] =
    "Devolve a raíz cadrada dun número.";
  ...
  Blockly.Msg["MATH_TRIG_TOOLTIP_COS"] =
    "Devolve o coseno dun grao (non radián).";
  Blockly.Msg["MATH_TRIG_TOOLTIP_SIN"] =
    "Devolve o seno dun grao (non radián).";
  Blockly.Msg["MATH_TRIG_TOOLTIP_TAN"] =
    "Devolve a tanxente dun grao (non radián).";
  ...
  Blockly.Msg["PROCEDURES_CALLNORETURN_TOOLTIP"] =
    'Executa a función definida polo usuario "%1".';
  Blockly.Msg["PROCEDURES_CALLRETURN_HELPURL"] =
    "https://en.wikipedia.org/wiki/Subroutine"; // untranslated
  Blockly.Msg["PROCEDURES_CALLRETURN_TOOLTIP"] =
    'Executa a función definida polo usuario "%1" e usa a súa devolución.';
  ...
  Blockly.Msg["PROCEDURES_DEFNORETURN_TOOLTIP"] =
    "Crea unha función sen devolución.";
  ...
  Blockly.Msg["PROCEDURES_DEFRETURN_TOOLTIP"] =
    "Crea unha función con devolución.";
  ...
  Blockly.Msg["PROCEDURES_IFRETURN_TOOLTIP"] =
    "Se un valor é verdadeiro, devolve un segundo valor.";
  ...
  Blockly.Msg["TEXT_CHANGECASE_TOOLTIP"] =
    "Devolve unha copia do texto nun caso diferente.";
  ...
  Blockly.Msg["TEXT_CHARAT_TOOLTIP"] =
    "Devolve a letra que está na posición especificada.";
  ...
  Blockly.Msg["TEXT_COUNT_TOOLTIP"] =
    "Conta cantas veces aparece un texto dentro doutro texto.";
  ...
  Blockly.Msg["TEXT_CREATE_JOIN_TOOLTIP"] =
    "Engade, elimina ou reordena as seccións para reconfigurar este bloque de texto.";
  Blockly.Msg["TEXT_GET_SUBSTRING_END_FROM_END"] =
    "ata a letra # desde o final";
  ...
  Blockly.Msg["TEXT_GET_SUBSTRING_START_FIRST"] =
    "obter a subcadea desde a primeira letra";
  Blockly.Msg["TEXT_GET_SUBSTRING_START_FROM_END"] =
    "obter a subcadea desde a letra # desde o final";
  Blockly.Msg["TEXT_GET_SUBSTRING_START_FROM_START"] =
    "obter a subcadea desde a letra #";
  Blockly.Msg["TEXT_GET_SUBSTRING_TAIL"] = ""; // untranslated
  Blockly.Msg["TEXT_GET_SUBSTRING_TOOLTIP"] =
    "Devolve unha parte especificada do texto.";
  ...
  Blockly.Msg["TEXT_INDEXOF_OPERATOR_FIRST"] =
    "atopar a primeira aparición do texto";
  Blockly.Msg["TEXT_INDEXOF_OPERATOR_LAST"] =
    "atopar a derradeira aparición do texto";
  Blockly.Msg["TEXT_INDEXOF_TITLE"] = "no texto %1 %2 %3";
  Blockly.Msg["TEXT_INDEXOF_TOOLTIP"] =
    "Devolve o índice da primeira/derradeira aparición do primeiro texto no segundo texto. Devolve %1 se non se atopa o texto.";
  ...
  Blockly.Msg["TEXT_ISEMPTY_TOOLTIP"] =
    "Devolve verdadeiro se o texto proporcionado está baleiro.";
  ...
  Blockly.Msg["TEXT_JOIN_TOOLTIP"] =
    "Crea un fragmento de texto unindo calquera número de elementos.";
  Blockly.Msg["TEXT_LENGTH_HELPURL"] =
    "https://github.com/google/blockly/wiki/Text#text-modification"; // untranslated
  Blockly.Msg["TEXT_LENGTH_TITLE"] = "lonxitude de %1";
  Blockly.Msg["TEXT_LENGTH_TOOLTIP"] =
    "Devolve o número de letras (incluídos os espazos) do texto proporcionado.";
  ...
  Blockly.Msg["TEXT_PRINT_TOOLTIP"] =
    "Imprime o texto, o número ou outro valor especificado.";
  ...
  Blockly.Msg["TEXT_REPLACE_TOOLTIP"] =
    "Substitúe todas as aparicións dun texto dentro doutro texto.";
  ...
  Blockly.Msg["TEXT_REVERSE_TOOLTIP"] =
    "Inverte a orde dos caracteres do texto.";
  ...
  Blockly.Msg["TEXT_TRIM_OPERATOR_BOTH"] =
    "eliminar os espazos de ambos os lados";
  Blockly.Msg["TEXT_TRIM_OPERATOR_LEFT"] =
    "eliminar os espazos do lado esquerdo de";
  Blockly.Msg["TEXT_TRIM_OPERATOR_RIGHT"] =
    "eliminar os espazos do lado dereito de";
  Blockly.Msg["TEXT_TRIM_TOOLTIP"] =
    "Devolve unha copia do texto cos espazos eliminados dun extremo ou de ambos.";
  ...
  Blockly.Msg["VARIABLES_SET_TOOLTIP"] =
    "Establece esta variable para que sexa igual á entrada.";
  Blockly.Msg["VARIABLE_ALREADY_EXISTS"] =
    'Xa existe unha variable co nome "%1".';
  Blockly.Msg["VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE"] =
    "Xa existe unha variable co nome \"%1\" para outro tipo: '%2'.";
