...
(function (root, factory) {
  ...
  Blockly.Msg["LISTS_ISEMPTY_TOOLTIP"] =
    "Повертає істину, якщо список порожній.";
  ...
  Blockly.Msg["LOGIC_BOOLEAN_TOOLTIP"] =
    "Повертає значення істина або хибність.";
  Blockly.Msg["LOGIC_BOOLEAN_TRUE"] = "істина";
  Blockly.Msg["LOGIC_COMPARE_HELPURL"] =
    "https://uk.wikipedia.org/wiki/Нерівність";
  ...
  Blockly.Msg["MATH_ROUND_HELPURL"] =
    "https://uk.wikipedia.org/wiki/Округлення";
  ...
  Blockly.Msg["MATH_ROUND_TOOLTIP"] =
    "Округлення числа до більшого або до меншого.";
  ...
  Blockly.Msg["TEXT_CHANGECASE_TOOLTIP"] =
    "В іншому випадку повертає копію тексту.";
  ...
  Blockly.Msg["TEXT_PROMPT_TOOLTIP_TEXT"] =
    "Запитати у користувача деякий текст.";
  ...
  Blockly.Msg["TEXT_TRIM_OPERATOR_BOTH"] =
    "вилучити крайні пропуски з обох кінців";
