 ...
 * @internal
 */
export declare function convertToolboxDefToJson(
 ...
 * @internal
 */
export declare function convertFlyoutDefToJsonArray(
 ...
 */
declare function hasCategoriesInternal(
  toolboxJson: ToolboxInfo | null,
): boolean;
/**
 ...
 * @internal
 */
export declare function isCategoryCollapsible(
 ...
 */
export declare function parseToolboxTree(
