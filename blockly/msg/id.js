...
(function (root, factory) {
  ...
  Blockly.Msg["CANNOT_DELETE_VARIABLE_PROCEDURE"] =
    "Tidak bisa menghapus variabel '%1' karena variabel ini bagian dari sebuah definisi dari fungsi '%2'";
  Blockly.Msg["CHANGE_VALUE_TITLE"] = "Ubah nilai:";
  Blockly.Msg["CLEAN_UP"] = "Bersihkan Blok";
  Blockly.Msg["COLLAPSED_WARNINGS_WARNING"] =
    "Blok yang diciutkan memiliki peringatan.";
  ...
  Blockly.Msg["CONTROLS_FOREACH_TITLE"] =
    "untuk setiap item %1 di dalam list %2";
  ...
  Blockly.Msg["LISTS_GET_SUBLIST_START_FIRST"] =
    "dapatkan sub-list dari pertama";
  ...
  Blockly.Msg["LISTS_REPEAT_TITLE"] =
    "buat list dengan item %1 diulang %2 kali";
  ...
  Blockly.Msg["MATH_ARITHMETIC_TOOLTIP_ADD"] =
    "Kembalikan jumlah dari kedua angka.";
  ...
  Blockly.Msg["MATH_ATAN2_TOOLTIP"] =
    "Kembalikan arctangen titik (X, Y) dalam derajat dari -180 hingga 180.";
  ...
  Blockly.Msg["MATH_ONLIST_TOOLTIP_RANDOM"] =
    "Kembalikan elemen acak dari list.";
  ...
  Blockly.Msg["MATH_ROUND_TOOLTIP"] =
    "Bulatkan suatu bilangan naik atau turun.";
  ...
  Blockly.Msg["RENAME_VARIABLE_TITLE"] =
    "Ubah nama semua variabel '%1' menjadi:";
  ...
  Blockly.Msg["TEXT_APPEND_TOOLTIP"] =
    "Tambahkan beberapa teks ke variabel '%1'.";
  ...
  Blockly.Msg["TEXT_CHARAT_TOOLTIP"] =
    "Kembalikan karakter dari posisi tertentu.";
  ...
  Blockly.Msg["TEXT_COUNT_TOOLTIP"] =
    "Hitung berapa banyak teks muncul dalam teks lain.";
  ...
  Blockly.Msg["TEXT_INDEXOF_OPERATOR_FIRST"] =
    "temukan kejadian pertama dalam teks";
  Blockly.Msg["TEXT_INDEXOF_OPERATOR_LAST"] =
    "temukan kejadian terakhir dalam teks";
  ...
  Blockly.Msg["TEXT_REPLACE_TOOLTIP"] =
    "Ganti semua kemunculan teks dalam teks lain.";
  ...
  Blockly.Msg["TEXT_TRIM_OPERATOR_BOTH"] =
    "pangkas ruang dari kedua belah sisi";
  ...
  Blockly.Msg["VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE"] =
    "Variabel yg bernama '%1' sudah ada untuk tipe lain: '%2'.";
