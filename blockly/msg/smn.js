...
(function (root, factory) {
  ...
  Blockly.Msg["CANNOT_DELETE_VARIABLE_PROCEDURE"] =
    "Ij lah máhđulâš sikkođ muttojeijee '%1' tanen ko tot lii uási funktio miäruštâllâm '%2'";
  ...
  Blockly.Msg["COLOUR_BLEND_TOOLTIP"] =
    "Siävvut kyevti ivne koskânis adelum koskâvuođâst (0.0 - 1.0).";
  ...
  Blockly.Msg["COLOUR_RGB_TOOLTIP"] =
    "Räähti ivne, mast lii tiätu meeri ruopsâd, ruánáá já čuovjâd. Puoh áárvuh kalgeh leđe 0 já 100 kooskâst.";
  ...
  Blockly.Msg["DELETE_VARIABLE_CONFIRMATION"] =
    "Sikkop-uv %1 kevttim muttojeijeest '%2'?";
  ...
  Blockly.Msg["MATH_ARITHMETIC_TOOLTIP_ADD"] =
    "Return the sum of the two numbers."; // untranslated
  ...
  Blockly.Msg["MATH_IS_TOOLTIP"] =
    "Täärhist lii-uv nummeer parâlâs, parâttem, algâloho, olesloho, positiivlâš, negatiivlâš, teikkâ jis tom puáhtá jyehiđ nube lovvoin. Maaccât tuotâ teikkâ epituotâ.";
  ...
  Blockly.Msg["MATH_ONLIST_TOOLTIP_AVERAGE"] =
    "Maaccât aritmaattisâš koskâáárvu adelum lovoin.";
  ...
  Blockly.Msg["MATH_SINGLE_TOOLTIP_ABS"] =
    "Return the absolute value of a number."; // untranslated
  ...
  Blockly.Msg["PROCEDURES_DEFNORETURN_TOOLTIP"] =
    "Räähti puáđushánnáá leijee funktio.";
  ...
  Blockly.Msg["RENAME_VARIABLE_TITLE"] =
    "Noomât uđđâsist puoh '%1' muttojeijee:";
  ...
  Blockly.Msg["VARIABLE_ALREADY_EXISTS"] =
    "Muttojeijee mon nommâ lii '%1' lii jo lemin.";
  Blockly.Msg["VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE"] =
    "Muttojeijee, mon nommâ lii '%1', lii jo lemin nube tiijpân: '%2'.";
