...
(function (root, factory) {
  ...
  Blockly.Msg["CANNOT_DELETE_VARIABLE_PROCEDURE"] =
    "Proměnnou '%1' není možné odstranit, protože je součástí definice funkce '%2'";
  ...
  Blockly.Msg["CONTROLS_FOR_TOOLTIP"] =
    "Nechá proměnnou '%1' nabývat hodnot od počátečního do koncového čísla po daném přírůstku a provádí příslušné bloky.";
  Blockly.Msg["CONTROLS_IF_ELSEIF_TOOLTIP"] =
    'Přidat podmínku do "pokud" bloku.';
  ...
  Blockly.Msg["CONTROLS_REPEAT_HELPURL"] =
    "https://cs.wikipedia.org/wiki/Cyklus_for";
  ...
  Blockly.Msg["DELETE_VARIABLE_CONFIRMATION"] =
    "Odstranit %1 použití proměnné '%2'";
  ...
  Blockly.Msg["MATH_ATAN2_TOOLTIP"] =
    "Vrací arkustangens bodu (X, Y) ve stupních od -180 do 180.";
  ...
  Blockly.Msg["MATH_ONLIST_OPERATOR_STD_DEV"] =
    "směrodatná odchylka ze seznamu";
  ...
  Blockly.Msg["MATH_ONLIST_TOOLTIP_STD_DEV"] =
    "Vrátí směrodatnou odchylku seznamu.";
  ...
  Blockly.Msg["MATH_SINGLE_TOOLTIP_LOG10"] =
    "Vrátí desítkový logaritmus čísla.";
  ...
  Blockly.Msg["TEXT_ISEMPTY_TOOLTIP"] =
    "Vrátí pravda pokud je zadaný text prázdný.";
