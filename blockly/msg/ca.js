...
(function (root, factory) {
  ...
  Blockly.Msg["COLLAPSED_WARNINGS_WARNING"] =
    "Els blocs plegats contenen avisos.";
  ...
  Blockly.Msg["CONTROLS_FOREACH_TITLE"] =
    "per a cada element %1 en la llista %2";
  ...
  Blockly.Msg["CONTROLS_IF_ELSEIF_TOOLTIP"] =
    "Afegeix una condició al bloc 'si'.";
  ...
  Blockly.Msg["CONTROLS_REPEAT_HELPURL"] =
    "https://ca.wikipedia.org/wiki/Bucle_For";
  ...
  Blockly.Msg["MATH_ARITHMETIC_TOOLTIP_ADD"] =
    "Retorna la suma dels dos nombres.";
  ...
  Blockly.Msg["MATH_ONLIST_TOOLTIP_MEDIAN"] =
    "Retorna la mediana de la llista.";
  ...
  Blockly.Msg["MATH_ROUND_HELPURL"] =
    "https://ca.wikipedia.org/wiki/Arrodoniment";
  ...
  Blockly.Msg["MATH_ROUND_TOOLTIP"] =
    "Arrodonir un nombre cap amunt o cap avall.";
  ...
  Blockly.Msg["MATH_TRIG_TOOLTIP_SIN"] =
    "Retorna el sinus d'un grau (no radiant).";
  ...
  Blockly.Msg["PROCEDURES_DEFRETURN_TOOLTIP"] =
    "Crea una funció amb una sortida.";
  ...
  Blockly.Msg["PROCEDURES_HIGHLIGHT_DEF"] =
    "Iluminar la definició de la funció";
  ...
  Blockly.Msg["PROCEDURES_MUTATORARG_TOOLTIP"] =
    "Afegir una entrada per la funció.";
  ...
  Blockly.Msg["RENAME_VARIABLE_TITLE"] =
    "Reanomena totes les variables '%1' a:";
  ...
  Blockly.Msg["TEXT_CHARAT_FROM_END"] =
    "recupera la lletra núm.# des del final";
  ...
  Blockly.Msg["TEXT_INDEXOF_OPERATOR_FIRST"] =
    "trobar la primera aparició del text";
  Blockly.Msg["TEXT_INDEXOF_OPERATOR_LAST"] =
    "trobar l'última aparició del text";
  ...
  Blockly.Msg["TEXT_TRIM_OPERATOR_BOTH"] =
    "retalla espais de tots dos extrems de";
