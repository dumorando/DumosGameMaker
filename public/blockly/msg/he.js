...
(function (root, factory) {
  ...
  Blockly.Msg["CONTROLS_FLOW_STATEMENTS_WARNING"] =
    "אזהרה: קוביה זו עשויה לשמש רק בתוך לולאה.";
  ...
  Blockly.Msg["CONTROLS_FOR_TOOLTIP"] =
    "לעשות שהערך ‚%1’ יקבל את הערכים מהמספר ההתחלתי עד המספר הסופי, בהתאם למרווח שהוגדר, ולבצע את הקוביות הנבחרות.";
  Blockly.Msg["CONTROLS_IF_ELSEIF_TOOLTIP"] = "תוסיף תנאי לבלוק If.";
  Blockly.Msg["CONTROLS_IF_ELSE_TOOLTIP"] =
    "ניתן להוסיף תנאי סופי שלוכד את כולם לקוביית ההתניה (If).";
  ...
  Blockly.Msg["CONTROLS_IF_IF_TOOLTIP"] =
    "ניתן להוסיף, למחוק או לסדר מחדש כדי להגדיר מחדש את קוביית ההתניה (If).";
  ...
  Blockly.Msg["CONTROLS_IF_TOOLTIP_2"] =
    "אם הערך הוא אמת, לבצע את קוביית הפעולות הראשונה. אחרת, לבצע את קוביית הפעולות השנייה.";
  Blockly.Msg["CONTROLS_IF_TOOLTIP_3"] =
    "אם הערך הראשון הוא אמת, לבצע את קוביית הפעולות הראשונה. אחרת, אם הערך השני הוא אמת, לבצע את קוביית הפעולות השנייה.";
  Blockly.Msg["CONTROLS_IF_TOOLTIP_4"] =
    "אם הערך הראשון הוא אמת, לבצע את קוביית הפעולות הראשונה. אחרת, אם הערך השני הוא אמת, לבצע את קוביית הפעולות השנייה. אם אף אחד מהם אינו נכון, לבצע את קוביית הפעולות האחרונה.";
  Blockly.Msg["CONTROLS_REPEAT_HELPURL"] =
    "http://he.wikipedia.org/wiki/בקרת_זרימה";
  ...
  Blockly.Msg["LISTS_CREATE_WITH_CONTAINER_TOOLTIP"] =
    "ניתן להוסיף, למחוק או לסדר מחדש סעיפים כדי להגדיר מחדש את קוביית הרשימה הזאת.";
  ...
  Blockly.Msg["LISTS_INDEX_OF_FIRST"] =
    "מחזירה את המיקום הראשון של פריט ברשימה";
  ...
  Blockly.Msg["LISTS_SET_INDEX_TOOLTIP_SET_LAST"] =
    "מגדיר את הפריט האחרון ברשימה.";
  Blockly.Msg["LISTS_SET_INDEX_TOOLTIP_SET_RANDOM"] =
    "מגדיר פריט אקראי ברשימה.";
  ...
  Blockly.Msg["LISTS_SPLIT_TOOLTIP_JOIN"] =
    "צירוף רשימת טקסטים לטקסט אחד, מופרדים בתו הפרדה.";
  Blockly.Msg["LISTS_SPLIT_TOOLTIP_SPLIT"] =
    "פיצול טקסט לרשימה של טקסטים, יחתכו לפי תו הפרדה.";
  ...
  Blockly.Msg["LOGIC_COMPARE_HELPURL"] =
    "https://he.wikipedia.org/wiki/אי-שוויון_(מתמטיקה)";
  ...
  Blockly.Msg["LOGIC_OPERATION_TOOLTIP_AND"] =
    "תחזיר נכון אם שני הקלטים נכונים.";
  ...
  Blockly.Msg["MATH_ATAN2_TOOLTIP"] =
    "מחזיר את הארכטנגנס של נקודה (X, Y) במעלות מ־‎-180 עד 180.";
  ...
  Blockly.Msg["MATH_CONSTANT_HELPURL"] =
    "https://he.wikipedia.org/wiki/קבוע_מתמטי";
  ...
  Blockly.Msg["MATH_MODULO_HELPURL"] =
    "https://he.wikipedia.org/wiki/חשבון_מודולרי";
  ...
  Blockly.Msg["MATH_ONLIST_TOOLTIP_MEDIAN"] =
    "תחזיר את המספר החיצוני ביותר ברשימה.";
  ...
  Blockly.Msg["MATH_RANDOM_FLOAT_TOOLTIP"] =
    "מחזיר שבר אקראי בין 0.0 (כולל) עד 1.0 (כולל).";
  ...
  Blockly.Msg["MATH_SINGLE_HELPURL"] =
    "https://he.wikipedia.org/wiki/שורש_ריבועי";
  ...
  Blockly.Msg["MATH_SINGLE_TOOLTIP_LOG10"] =
    "החזרת הלוגריתם לפי בסיס עשר של מספר.";
  ...
  Blockly.Msg["PROCEDURES_IFRETURN_TOOLTIP"] =
    "אם ערך נכון, אז להחזיר ערך שני.";
  Blockly.Msg["PROCEDURES_IFRETURN_WARNING"] =
    "אזהרה: קוביה זו עשויה לשמש רק בתוך הגדרה של פונקציה.";
  ...
  Blockly.Msg["TEXT_COUNT_TOOLTIP"] =
    "סופרת כמה פעמים טקסט מסוים מופיע בתוך טקסט אחר.";
  ...
  Blockly.Msg["TEXT_CREATE_JOIN_TOOLTIP"] =
    "ניתן להוסיף, להסיר או לסדר מחדש סעיפים כדי להגדיר את קוביית הטקסט הזאת מחדש.";
  ...
  Blockly.Msg["TEXT_JOIN_TOOLTIP"] =
    "יצירת מקטע טקסט על ידי צירוף של כמות כלשהי של פריטים יחדיו.";
  ...
  Blockly.Msg["TEXT_REPLACE_TOOLTIP"] =
    "מחליפה את כל המופעים של טקסט מסוים בתוך טקסט אחר.";
