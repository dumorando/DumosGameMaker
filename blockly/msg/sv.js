...
(function (root, factory) {
  ...
  Blockly.Msg["CONTROLS_IF_ELSEIF_TOOLTIP"] =
    'Lägg till ett villkor blocket "om".';
  ...
  Blockly.Msg["CONTROLS_REPEAT_TOOLTIP"] =
    "Utför några kommandon flera gånger.";
  ...
  Blockly.Msg["LOGIC_BOOLEAN_TOOLTIP"] =
    "Returnerar antingen sant eller falskt.";
  Blockly.Msg["LOGIC_BOOLEAN_TRUE"] = "sant";
  Blockly.Msg["LOGIC_COMPARE_HELPURL"] =
    "https://sv.wikipedia.org/wiki/Olikhet";
  ...
  Blockly.Msg["MATH_ONLIST_TOOLTIP_MIN"] =
    "Ger tillbaka det minsta talet i listan.";
  ...
  Blockly.Msg["MATH_ROUND_HELPURL"] =
    "https://sv.wikipedia.org/wiki/Avrundning";
  ...
  Blockly.Msg["MATH_SINGLE_HELPURL"] =
    "https://sv.wikipedia.org/wiki/Kvadratrot";
  ...
  Blockly.Msg["MATH_SINGLE_TOOLTIP_POW10"] =
    "Ger tillbaka 10 upphöjt i ett tal.";
  ...
  Blockly.Msg["PROCEDURES_DEFNORETURN_HELPURL"] =
    "https://sv.wikipedia.org/wiki/Funktion_(programmering)";
  ...
  Blockly.Msg["PROCEDURES_DEFNORETURN_TOOLTIP"] =
    "Skapar en funktion utan output.";
  ...
  Blockly.Msg["TEXT_APPEND_TOOLTIP"] =
    "Lägg till lite text till variabeln '%1'.";
  ...
  Blockly.Msg["TEXT_GET_SUBSTRING_START_FIRST"] =
    "få textdel från första bokstaven";
  ...
  Blockly.Msg["TEXT_GET_SUBSTRING_START_FROM_START"] =
    "få textdel från bokstav #";
  Blockly.Msg["TEXT_GET_SUBSTRING_TAIL"] = ""; // untranslated
  Blockly.Msg["TEXT_GET_SUBSTRING_TOOLTIP"] =
    "Ger tillbaka en viss del av texten.";
  ...
  Blockly.Msg["TEXT_INDEXOF_OPERATOR_FIRST"] =
    "hitta första förekomsten av texten";
  Blockly.Msg["TEXT_INDEXOF_OPERATOR_LAST"] =
    "hitta sista förekomsten av texten";
  ...
  Blockly.Msg["TEXT_TRIM_OPERATOR_BOTH"] =
    "ta bort mellanrum från båda sidorna av";
  Blockly.Msg["TEXT_TRIM_OPERATOR_LEFT"] =
    "ta bort mellanrum från vänstra sidan av";
  Blockly.Msg["TEXT_TRIM_OPERATOR_RIGHT"] =
    "ta bort mellanrum från högra sidan av";
