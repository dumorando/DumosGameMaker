 ...
 */
export declare function createSvgElement<T extends SVGElement>(
  name: string | Svg<T>,
  attrs: {
 ...
 */
export declare function removeClasses(
  element: Element,
  classNames: string,
): void;
/**
 ...
 */
export declare function setCssTransform(
 ...
 * @returns Width of element.
 */
export declare function getFastTextWidth(
 ...
 * @returns Width of element.
 */
export declare function getFastTextWidthWithSizeString(
  textElement: SVGTextElement,
  fontSize: string,
  fontWeight: string,
  fontFamily: string,
 ...
 */
export declare function measureFontMetrics(
  text: string,
  fontSize: string,
  fontWeight: string,
  fontFamily: string,
