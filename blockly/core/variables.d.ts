 ...
 */
export declare function generateUniqueNameFromOptions(
  startChar: string,
  usedNames: string[],
): string;
/**
 ...
 */
export declare function createVariableButtonHandler(
  workspace: Workspace,
 ...
 *     an existing variable was chosen.
 */
export declare function renameVariable(
  workspace: Workspace,
 ...
 */
export declare function promptName(
  promptText: string,
  defaultText: string,
 ...
 */
export declare function nameUsedWithAnyType(
  name: string,
  workspace: Workspace,
): VariableModel | null;
/**
 ...
 * @internal
 */
export declare function nameUsedWithConflictingParam(
  oldName: string,
  newName: string,
  workspace: Workspace,
): string | null;
 ...
 */
export declare function generateVariableFieldDom(
 ...
 *     combination.
 */
export declare function getOrCreateVariablePackage(
  workspace: Workspace,
  id: string | null,
  opt_name?: string,
  opt_type?: string,
 ...
 * @internal
 */
export declare function getAddedVariables(
  workspace: Workspace,
