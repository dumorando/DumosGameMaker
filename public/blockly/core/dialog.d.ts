 ...
 */
export declare function setAlert(
  alertFunction: (p1: string, p2?: () => void) => void,
): void;
/**
 ...
 */
declare function confirmInternal(
  message: string,
  callback: (p1: boolean) => void,
): void;
/**
 ...
 */
export declare function setConfirm(
 ...
 */
export declare function setPrompt(
  promptFunction: (
    p1: string,
    p2: string,
