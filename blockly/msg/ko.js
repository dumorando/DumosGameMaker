...
(function (root, factory) {
  ...
  Blockly.Msg["CONTROLS_FOR_TOOLTIP"] =
    "변수 '%1'이(가) 지정된 간격으로 시작 번호에서 끝 번호까지 세는 동시에 지정된 블록을 실행하게 하세요.";
  ...
  Blockly.Msg["CONTROLS_REPEAT_HELPURL"] =
    "https://ko.wikipedia.org/wiki/For_루프";
  ...
  Blockly.Msg["MATH_CONSTANT_HELPURL"] =
    "https://ko.wikipedia.org/wiki/수학_상수";
  ...
  Blockly.Msg["MATH_NUMBER_HELPURL"] =
    "https://ko.wikipedia.org/wiki/수_(수학)";
