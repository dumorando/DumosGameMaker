...
(function (root, factory) {
  ...
  Blockly.Msg["COLLAPSED_WARNINGS_WARNING"] =
    "Zrútené bloky obsahujú varovanie.";
  ...
  Blockly.Msg["CONTROLS_IF_TOOLTIP_1"] =
    "Ak je hodnota pravda, vykonaj príkazy.";
  ...
  Blockly.Msg["LISTS_REPEAT_TITLE"] =
    "vytvor zoznam s prvkom %1 opakovaným %2 krát";
  ...
  Blockly.Msg["LISTS_SORT_TYPE_IGNORECASE"] =
    "abecedne, ignorovať veľkosť písmen";
  ...
  Blockly.Msg["LOGIC_BOOLEAN_TOOLTIP"] =
    "Vráť buď hodnotu pravda alebo nepravda.";
  ...
  Blockly.Msg["MATH_ARITHMETIC_TOOLTIP_POWER"] =
    "Vráť prvé číslo umocnené druhým.";
  ...
  Blockly.Msg["MATH_MODULO_TOOLTIP"] =
    "Vráť zvyšok po delení jedného čísla druhým.";
  ...
  Blockly.Msg["MATH_ONLIST_TOOLTIP_MODE"] =
    "Vrátiť najčastejší prvok v zozname.";
  Blockly.Msg["MATH_ONLIST_TOOLTIP_RANDOM"] =
    "Vráť náhodne zvolený prvok zoznamu.";
  Blockly.Msg["MATH_ONLIST_TOOLTIP_STD_DEV"] =
    "Vráť smeroddajnú odchýlku zoznamu.";
  Blockly.Msg["MATH_ONLIST_TOOLTIP_SUM"] =
    "Vráť súčet všetkých čísel v zozname.";
  ...
  Blockly.Msg["MATH_SINGLE_TOOLTIP_LOG10"] =
    "Vráť logaritmus čísla so základom 10.";
  ...
  Blockly.Msg["TEXT_JOIN_TOOLTIP"] =
    "Vytvor text spojením určitého počtu prvkov.";
  ...
  Blockly.Msg["TEXT_REPLACE_TOOLTIP"] =
    "Zameniť všetky výskyty textu za iný text.";
