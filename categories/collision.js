...
javascript.javascriptGenerator.forBlock['collision_add_area'] = function(block, generator) {
  ...
  javascript.javascriptGenerator.forBlock['collision_grounded'] = function(block, generator) {
    var variable_name = generator.nameDB_.getName(
        block.getFieldValue("GAMEOBJECT"),
        Blockly.Names.NameType.VARIABLE,
      );
