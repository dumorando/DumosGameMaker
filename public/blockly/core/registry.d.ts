...
export declare class Type<_T> {
  ...
  /** @internal */
  static PASTER: Type<
    IPaster<ICopyable.ICopyData, ICopyable<ICopyable.ICopyData>>
  >;
}
/**
...
export declare function register<T>(
  type: string | Type<T>,
  name: string,
  registryItem: (new (...p1: any[]) => T) | null | any,
 ...
 * @param name The plugin's name. (Ex. field_angle, geras)
 */
export declare function unregister<T>(
  type: string | Type<T>,
  name: string,
): void;
/**
 ...
 *     otherwise.
 */
export declare function hasItem<T>(
  type: string | Type<T>,
  name: string,
): boolean;
/**
 ...
 */
export declare function getClass<T>(
  type: string | Type<T>,
  name: string,
 ...
 */
export declare function getObject<T>(
  type: string | Type<T>,
  name: string,
  opt_throwIfMissing?: boolean,
): T | null;
 ...
 */
export declare function getClassFromOptions<T>(
  type: Type<T>,
  options: Options,
  opt_throwIfMissing?: boolean,
): (new (...p1: any[]) => T) | null;
