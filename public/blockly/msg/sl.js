...
(function (root, factory) {
  ...
  Blockly.Msg["COLLAPSED_WARNINGS_WARNING"] =
    "Skrčeni bloki vsebujejo opozorila.";
  ...
  Blockly.Msg["COLOUR_BLEND_TOOLTIP"] =
    "Zmeša dve barvi v določene razmerju (0,0 – 1,0).";
  ...
  Blockly.Msg["CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE"] =
    "nadaljuj z naslednjo iteracijo zanke";
  Blockly.Msg["CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK"] =
    "Prekine vsebujočo zanko.";
  Blockly.Msg["CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE"] =
    "Preskočite preostanek te zanke in nadaljujte z naslednjo iteracijo.";
  Blockly.Msg["CONTROLS_FLOW_STATEMENTS_WARNING"] =
    "Pozor: Ta blok lahko uporabite znotraj zanke samo enkrat.";
  ...
  Blockly.Msg["CONTROLS_FOREACH_TOOLTIP"] =
    "Za vsak element v seznamu nastavi spremenljivko »%1« na ta element. Pri tem se izvedejo določeni stavki.";
  ...
  Blockly.Msg["CONTROLS_FOR_TOOLTIP"] =
    "Vrednost spremenljivke »%1« se v določenem koraku spreminja od začetnega do končnega števila. Pri tem se izvedejo določeni bloki.";
  ...
  Blockly.Msg["CONTROLS_IF_IF_TOOLTIP"] =
    "Dodajte, odstranite ali spremenite vrstni red odsekov za ponovno nastavitev bloka »če«.";
  ...
  Blockly.Msg["CONTROLS_IF_TOOLTIP_1"] =
    "Če je vrednost resnična, izvedi določene stavke.";
  Blockly.Msg["CONTROLS_IF_TOOLTIP_2"] =
    "Če je vrednost resnična, izvedi prvo skupino stavkov. Sicer izvedi drugo skupino stavkov.";
  Blockly.Msg["CONTROLS_IF_TOOLTIP_3"] =
    "Če je prva vrednost resnična, izvedi prvo skupino stavkov. Sicer, če je resnična druga vrednost, izvedi drugo skupino stavkov.";
  Blockly.Msg["CONTROLS_IF_TOOLTIP_4"] =
    "Če je prva vrednost resnična, izvedi prvo skupino stavkov. Sicer, če je resnična druga vrednost, izvedi drugo skupino stavkov. Če ni resnična nobena od vrednosti, izvedi zadnjo skupino stavkov.";
  Blockly.Msg["CONTROLS_REPEAT_HELPURL"] =
    "https://sl.wikipedia.org/wiki/Zanka_for";
  ...
  Blockly.Msg["CONTROLS_REPEAT_TOOLTIP"] =
    "Določeni stavki se izvedejo večkrat.";
  ...
  Blockly.Msg["CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL"] =
    "Določeni stavki se izvajajo, dokler je vrednost neresnična.";
  Blockly.Msg["CONTROLS_WHILEUNTIL_TOOLTIP_WHILE"] =
    "Določeni stavki se izvajajo, dokler je vrednost resnična.";
  ...
  Blockly.Msg["LISTS_CREATE_EMPTY_TOOLTIP"] =
    "Vrne seznam dolžine 0, ki ne vsebuje nobenih podatkovnih zapisov.";
  Blockly.Msg["LISTS_CREATE_WITH_CONTAINER_TITLE_ADD"] = "seznam";
  Blockly.Msg["LISTS_CREATE_WITH_CONTAINER_TOOLTIP"] =
    "Doda, odstrani ali spremeni vrstni red blokov seznama.";
  ...
  Blockly.Msg["LISTS_GET_SUBLIST_START_FIRST"] =
    "ustvari podseznam od prvega mesta";
  ...
  Blockly.Msg["LISTS_REPEAT_TOOLTIP"] =
    "Ustvari seznam iz dane vrednosti z določenim številom ponovitev.";
  ...
  Blockly.Msg["LISTS_SET_INDEX_TOOLTIP_INSERT_LAST"] =
    "Pripne element na konec seznama.";
  ...
  Blockly.Msg["LISTS_SPLIT_TOOLTIP_JOIN"] =
    "Spoji seznam besedil v eno besedilo z razmejevalcem med besedili.";
  Blockly.Msg["LISTS_SPLIT_TOOLTIP_SPLIT"] =
    "Razdruži besedilo v seznam besedil s prelomom pri vsakem ločilu.";
  ...
  Blockly.Msg["LOGIC_COMPARE_TOOLTIP_EQ"] =
    "Vrne resnično, če sta vnosa enaka.";
  ...
  Blockly.Msg["LOGIC_COMPARE_TOOLTIP_NEQ"] =
    "Vrne resnično, če vnosa nista enaka.";
  ...
  Blockly.Msg["MATH_ARITHMETIC_HELPURL"] =
    "https://sl.wikipedia.org/wiki/Aritmetika";
  ...
  Blockly.Msg["MATH_CONSTANT_HELPURL"] =
    "https://sl.wikipedia.org/wiki/Matematična_konstanta";
  Blockly.Msg["MATH_CONSTANT_TOOLTIP"] =
    "Vrne eno izmed pogostih konstant: π (3,141…), e (2,718…), φ (1,618…), sqrt(2) (1,414…), sqrt(½) (0,707 ...) ali ∞ (neskončno).";
  ...
  Blockly.Msg["MATH_IS_TOOLTIP"] =
    "Preveri, ali je število sodo, liho, praštevilo, celo, pozitivno, negativno ali če je deljivo z določenim številom. Vrne resnično ali neresnično.";
  ...
  Blockly.Msg["MATH_NUMBER_HELPURL"] =
    "https://sl.wikipedia.org/wiki/%C5%A0tevilo";
  ...
  Blockly.Msg["MATH_ONLIST_TOOLTIP_RANDOM"] =
    "Vrne naključno število izmed števil v seznamu.";
  ...
  Blockly.Msg["MATH_ROUND_HELPURL"] =
    "https://sl.wikipedia.org/wiki/Zaokro%C5%BEanje";
  ...
  Blockly.Msg["MATH_SINGLE_HELPURL"] =
    "https://sl.wikipedia.org/wiki/Kvadratni_koren";
  ...
  Blockly.Msg["MATH_SINGLE_TOOLTIP_LOG10"] =
    "Vrne desetiški logaritem števila.";
  ...
  Blockly.Msg["MATH_TRIG_HELPURL"] =
    "https://sl.wikipedia.org/wiki/Trigonometrična_funkcija";
  ...
  Blockly.Msg["PROCEDURES_CALLNORETURN_HELPURL"] =
    "https://sl.wikipedia.org/wiki/Subrutina";
  Blockly.Msg["PROCEDURES_CALLNORETURN_TOOLTIP"] =
    "Izvede uporabniško določeno funkcijo »%1«.";
  ...
  Blockly.Msg["PROCEDURES_IFRETURN_WARNING"] =
    "Pozor: Ta blok lahko uporabite samo v bloku funkcije.";
  ...
  Blockly.Msg["PROCEDURES_MUTATORCONTAINER_TOOLTIP"] =
    "Doda, odstrani ali spremeni vrstni red vnosov za to funkcijo.";
  ...
  Blockly.Msg["TEXT_APPEND_TOOLTIP"] =
    "Pripne neko besedilo spremenljivki »%1«.";
  ...
  Blockly.Msg["TEXT_CHANGECASE_TOOLTIP"] =
    "Vrne kopijo besedila v drugi obliki.";
  ...
  Blockly.Msg["TEXT_COUNT_TOOLTIP"] =
    "Preštej, kolikokrat se neko besedilo pojavi v drugem besedilu.";
  ...
  Blockly.Msg["TEXT_CREATE_JOIN_TOOLTIP"] =
    "Doda, odstrani ali spremeni vrstni red odsekov za ponovno nastavitev tega bloka besedila.";
  ...
  Blockly.Msg["TEXT_GET_SUBSTRING_START_FROM_END"] =
    "vrni podniz od črke št. od konca";
  Blockly.Msg["TEXT_GET_SUBSTRING_START_FROM_START"] =
    "vrni podniz od črke št.";
  ...
  Blockly.Msg["TEXT_REPLACE_TOOLTIP"] =
    "Zamenja vse pojavitve besedila v drugem besedilu.";
  ...
  Blockly.Msg["VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE"] =
    "Spremenljivka z imenom »%1« za tip »%2« že obstaja.";
