...
(function (root, factory) {
  ...
  Blockly.Msg["COLOUR_PICKER_TOOLTIP"] =
    "Sicht eng Faarf an der Palette eraus.";
  ...
  Blockly.Msg["DELETE_VARIABLE_CONFIRMATION"] =
    "%1 Verwendunge vun der Variabel '%2' läschen?";
  ...
  Blockly.Msg["LISTS_GET_INDEX_TOOLTIP_GET_RANDOM"] =
    "Gëtt en zoufällegt Element aus enger Lëscht zréck.";
  ...
  Blockly.Msg["MATH_ONLIST_OPERATOR_RANDOM"] =
    "zoufällegt Element vun enger Lëscht";
  ...
  Blockly.Msg["MATH_RANDOM_INT_TITLE"] =
    "zoufälleg ganz Zuel tëscht %1 a(n) %2";
  ...
  Blockly.Msg["PROCEDURES_IFRETURN_WARNING"] =
    "Opgepasst: Dëse Block däerf nëmmen bannent enger Funktiounsdefitioun benotzt ginn.";
  ...
  Blockly.Msg["VARIABLE_ALREADY_EXISTS"] =
    "Et gëtt schonn eng Variabel mam Numm '%1'.";
  Blockly.Msg["VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE"] =
    "Et gëtt schonn eng Variabel mam Numm '%1' fir een aneren Typ: '%2'.";
