...
(function (root, factory) {
  ...
  Blockly.Msg["CONTROLS_FOREACH_TITLE"] =
    "per cada element %1 dins la lista %2";
  ...
  Blockly.Msg["CONTROLS_IF_ELSEIF_TOOLTIP"] =
    "Apondre una condicion al blòt 'se'.";
  ...
  Blockly.Msg["CONTROLS_REPEAT_HELPURL"] =
    "https://oc.wikipedia.org/wiki/For_loop";
  ...
  Blockly.Msg["MATH_ARITHMETIC_TOOLTIP_ADD"] =
    "Renvia la soma dels dos nombres.";
  ...
  Blockly.Msg["MATH_SINGLE_HELPURL"] =
    "https://fr.wikipedia.org/wiki/Racine_carree";
  ...
  Blockly.Msg["MATH_SINGLE_TOOLTIP_POW10"] =
    "Renvia 10 a la poténcia d’un nombre.";
  Blockly.Msg["MATH_SINGLE_TOOLTIP_ROOT"] =
    "Renvia la raiç carrada d’un nombre.";
  ...
  Blockly.Msg["RENAME_VARIABLE_TITLE"] =
    "Renomenar totas las variablas « %1 » a :";
  ...
  Blockly.Msg["TEXT_CHARAT_TOOLTIP"] =
    "Renvia la letra a la posicion indicada.";
  ...
  Blockly.Msg["TEXT_TRIM_OPERATOR_BOTH"] =
    "suprimir los espacis dels dos costats";
  ...
  Blockly.Msg["VARIABLE_ALREADY_EXISTS"] =
    'Existís ja una variabla nomenada "%1".';
  Blockly.Msg["VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE"] =
    "Una variabla nommada '%1' existís ja per un autre tipe ; '%2'.";
