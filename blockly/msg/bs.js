...
(function (root, factory) {
  ...
  Blockly.Msg["CANNOT_DELETE_VARIABLE_PROCEDURE"] =
    'Ne mogu izbrisati varijablu "%1" jer je dio definicije funckije "%2"';
  ...
  Blockly.Msg["COLOUR_BLEND_TOOLTIP"] =
    "Pomiješaj dvije boje zajedno sa zadanim odnosom (0.0 - 1.0).";
  ...
  Blockly.Msg["COLOUR_RGB_TOOLTIP"] =
    "Napravi boju s određenom količinom crvene, zelene i plave boje. Sve vrijednosti moraju biti između 0 i 100.";
  ...
  Blockly.Msg["CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE"] =
    "nastavi sa sljedećom iteracijom petlje";
  Blockly.Msg["CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK"] =
    "Napusti petlju koja sadrži ovaj blok.";
  Blockly.Msg["CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE"] =
    "Preskoči ostatak ove petlje i nastavi sa sljedećom iteracijom.";
  ...
  Blockly.Msg["CONTROLS_FOREACH_TOOLTIP"] =
    'Za svaku stavku na spisku, dodjeljuje vrijednost stavke varijabli "%1", a zatim izvršava neke naredbe.';
  ...
  Blockly.Msg["CONTROLS_FOR_TOOLTIP"] =
    'Neka varijabla "%1" uzima vrijednosti od početnog do krajnjeg broja, brojeći po određenom intervalu i neka izvršava određene blokove.';
  Blockly.Msg["CONTROLS_IF_ELSEIF_TOOLTIP"] = 'Dodajte uslov bloku "ako".';
  Blockly.Msg["CONTROLS_IF_ELSE_TOOLTIP"] =
    "Dodaj konačni, sveobuhvatni uvjet u if blok.";
  ...
  Blockly.Msg["CONTROLS_IF_IF_TOOLTIP"] =
    "Dodaj, ukloni ili promijeni redoslijed sekcija kako bi ponovo konfigurisali ovaj if blok.";
  ...
  Blockly.Msg["CONTROLS_IF_TOOLTIP_1"] =
    "Ako je vrijednost tačna, izvršava neke naredbe.";
  Blockly.Msg["CONTROLS_IF_TOOLTIP_2"] =
    "Ako je vrijednost tačna, izvršava neke naredbe. U suprotnom, izvršava drugi blok naredbi.";
  Blockly.Msg["CONTROLS_IF_TOOLTIP_3"] =
    "Ako je prva vrijednost tačna, onda izvrši prvi blok naredbi. U suprotnom, ako je druga vrijednost tačna, izvrši drugi blok naredbi.";
  Blockly.Msg["CONTROLS_IF_TOOLTIP_4"] =
    "Ako je prva vrijednost tačna, onda izvrši prvi blok naredbi. U suprotnom, ako je druga vrijednost tačna, izvrši drugi blok naredbi. Ako nijedna od vrijednosti nije tačna, izvrši posljednji blok naredbi.";
  ...
  Blockly.Msg["CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL"] =
    "Dok je vrijednost netačna, izvršava neke naredbe.";
  Blockly.Msg["CONTROLS_WHILEUNTIL_TOOLTIP_WHILE"] =
    "Dok je vrijednost tačna, izvršava neke naredbe.";
  ...
  Blockly.Msg["DELETE_VARIABLE_CONFIRMATION"] =
    'Izbrisati %1 upotrebu varijable "%2"?';
  ...
  Blockly.Msg["LISTS_GET_SUBLIST_START_FROM_END"] =
    "get sub-list from # from end"; // untranslated
  ...
  Blockly.Msg["LISTS_INDEX_OF_LAST"] =
    "pronađi posljednje pojavljivanje stavke";
  ...
  Blockly.Msg["LISTS_REPEAT_TITLE"] =
    "create list with item %1 repeated %2 times"; // untranslated
  ...
  Blockly.Msg["LISTS_SET_INDEX_TOOLTIP_SET_LAST"] =
    "Sets the last item in a list."; // untranslated
  ...
  Blockly.Msg["LOGIC_COMPARE_HELPURL"] =
    "https://bs.wikipedia.org/wiki/Nejednakost";
  Blockly.Msg["LOGIC_COMPARE_TOOLTIP_EQ"] =
    "Vraća tačno ako su oba ulaza jednaka jedan drugom.";
  Blockly.Msg["LOGIC_COMPARE_TOOLTIP_GT"] =
    "Vraća tačno ako je prvi ulaz veći od drugog ulaza.";
  Blockly.Msg["LOGIC_COMPARE_TOOLTIP_GTE"] =
    "Vraća tačno ako je prvi ulaz veći ili jednak drugom ulazu.";
  Blockly.Msg["LOGIC_COMPARE_TOOLTIP_LT"] =
    "Vraća tačno ako je prvi ulaz manji od drugog ulaza.";
  Blockly.Msg["LOGIC_COMPARE_TOOLTIP_LTE"] =
    "Vraća tačno ako je prvi ulaz manji ili jednak drugom ulazu.";
  ...
  Blockly.Msg["LOGIC_NEGATE_TOOLTIP"] =
    "Vraća tačno ako je unos netačan. Vraća netačno ako je unos tačan.";
  ...
  Blockly.Msg["LOGIC_OPERATION_TOOLTIP_AND"] =
    "Vraća tačno ako su oba ulaza tačna.";
  Blockly.Msg["LOGIC_OPERATION_TOOLTIP_OR"] =
    "Vrati tačno ako je barem jedan od ulaza istinit.";
  ...
  Blockly.Msg["MATH_ARITHMETIC_HELPURL"] =
    "https://bs.wikipedia.org/wiki/Aritmetika";
  ...
  Blockly.Msg["MATH_ARITHMETIC_TOOLTIP_POWER"] =
    "Vraća prvi broj na eksponent drugog broja.";
  ...
  Blockly.Msg["MATH_CONSTANT_HELPURL"] =
    "https://bs.wikipedia.org/wiki/Matemati%C4%8Dka_konstanta";
  Blockly.Msg["MATH_CONSTANT_TOOLTIP"] =
    "Vraća jednu od uobičajenih konstanti: π (3.141…), e (2.718…), φ (1.618…), sqrt(2) (1.414…), sqrt(½) (0.707…) ili ∞ (beskonačnost).";
  ...
  Blockly.Msg["MATH_IS_TOOLTIP"] =
    "Provjerava da li je broj paran, neparan, prost, cijeli, pozitivan, negativan ili je djeljiv s određenim brojem. Vraća tačno ili netačno.";
  ...
  Blockly.Msg["MATH_ONLIST_TOOLTIP_MAX"] =
    "Return the largest number in the list."; // untranslated
  ...
  Blockly.Msg["MATH_ONLIST_TOOLTIP_MIN"] =
    "Return the smallest number in the list."; // untranslated
  ...
  Blockly.Msg["MATH_ROUND_TOOLTIP"] =
    "Zaokružuje broj na veću ili manju vrijednost.";
  Blockly.Msg["MATH_SINGLE_HELPURL"] =
    "https://bs.wikipedia.org/wiki/Kvadratni_korijen";
  ...
  Blockly.Msg["MATH_SINGLE_TOOLTIP_LOG10"] =
    "Vraća logoritam broja za bazu 10.";
  ...
  Blockly.Msg["MATH_TRIG_HELPURL"] =
    "https://bs.wikipedia.org/wiki/Trigonometrijska_funkcija";
  ...
  Blockly.Msg["PROCEDURES_DEFRETURN_TOOLTIP"] =
    "Creates a function with an output."; // untranslated
  ...
  Blockly.Msg["PROCEDURES_MUTATORARG_TOOLTIP"] =
    "Add an input to the function."; // untranslated
  ...
  Blockly.Msg["TEXT_GET_SUBSTRING_START_FIRST"] =
    "get substring from first letter"; // untranslated
  ...
  Blockly.Msg["TEXT_GET_SUBSTRING_START_FROM_START"] =
    "get substring from letter #"; // untranslated
  ...
  Blockly.Msg["VARIABLE_ALREADY_EXISTS"] =
    'Varijabla s imenom "%1" već postoji.';
  Blockly.Msg["VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE"] =
    'Varijabla s imenom "%1" već postoji za drugu vrstu: "%2".';
