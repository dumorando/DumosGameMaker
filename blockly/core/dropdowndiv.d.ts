 ...
 */
export declare function setColour(
 ...
 */
export declare function showPositionedByBlock<T>(
  field: Field<T>,
  block: BlockSvg,
  opt_onHide?: Function,
 ...
 * @returns True if the menu rendered below block; false if above.
 */
export declare function showPositionedByField<T>(
  field: Field<T>,
  opt_onHide?: Function,
  opt_secondaryYOffset?: number,
): boolean;
 ...
 * @internal
 */
export declare function getPositionX(
  sourceX: number,
  boundsLeft: number,
  boundsRight: number,
  divWidth: number,
 ...
 */
export declare function hideIfOwner<T>(
  divOwner: Field<T>,
