            ...
            (("classList" in document.createElement("_") &&
              ...
              (function (e) {
                ...
                if ("Element" in e) {
                  ...
                  } else i[n].__defineGetter__ && o.__defineGetter__(t, u);
                }
              })(window.self),
            (function () {
              "use strict";
      ...
      2: [
        function (e, t, n) {
          t.exports = function (e, t) {
            ...
            var s = r[o] || r._default,
              l = s[0],
              a = s[1],
              c = s[2];
            (i = t.createElement("div")).innerHTML = a + e + c;
            for (; l--; ) i = i.lastChild;
            if (i.firstChild == i.lastChild) return i.removeChild(i.firstChild);
            var d = t.createDocumentFragment();
            for (; i.firstChild; ) d.appendChild(i.removeChild(i.firstChild));
            return d;
          };
          var o,
            i = !1;
        ...
        function (e, t, n) {
          ...
          function o(e, t) {
            ...
            for (var n = Object(e), o = 1; o < arguments.length; o++) {
              ...
              if (null != i)
                for (
                  var r = Object.keys(Object(i)), s = 0, l = r.length;
                  s < l;
                  s++
                ) {
                  var a = r[s],
                    c = Object.getOwnPropertyDescriptor(i, a);
                  void 0 !== c && c.enumerable && (n[a] = i[a]);
                }
            }
            return n;
          }
      ...
      4: [
        function (e, t, n) {
              ...
              open: function (e) {
                ...
                (n.id = v++),
                  ...
                  (n.close = function () {
                    ...
                    var e = this.options;
                    if (h && !e.escapeButtonCloses) return !1;
                    if (
                      !1 ===
                      function () {
                    ...
                    var o = n("") || n("-webkit-") || n("-moz-") || n("-o-"),
                      i = function t() {
                        this.rootEl.parentNode &&
                          (this.rootEl.removeEventListener(s, t),
                          this.overlayEl.removeEventListener(s, t),
                          delete p[this.id],
                    ...
                    return (
                      s && o
                        ? (this.rootEl.addEventListener(s, i),
                          this.overlayEl.addEventListener(s, i),
                          this.rootEl.classList.add(u),
                          this.overlayEl.classList.add(u))
                        : i(),
                      !0
                    );
                  }),
                ...
                var g = (n.options = Object.assign({}, m.defaultOptions, e)),
                  y = (n.bodyEl = document.getElementsByTagName("body")[0]),
                  b = (n.rootEl = document.createElement("div"));
                b.classList.add(l), r(b, g.className);
                ...
                C.classList.add(c),
                  ...
                  y.appendChild(C);
                var E = (n.contentEl = document.createElement("div"));
                if (
                  (E.classList.add(a),
                  r(E, g.contentClassName),
                  E.appendChild(
                  ...
                  var w = (n.closeEl = document.createElement("div"));
                  w.classList.add(d),
                    r(w, g.closeClassName),
                    w.addEventListener("click", n.close.bind(n)),
                    E.appendChild(w);
                }
                return (
                  document.querySelector(g.appendLocation).appendChild(b),
          ...
          window.addEventListener("keyup", function (e) {
            27 === e.keyCode && ((h = !0), m.closeTop(), (h = !1));
          }),
