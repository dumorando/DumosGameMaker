...
`,
          ...
          "(" +
          d +
          ("FROM_END" === e || "FROM_START" === e ? ", " + g : "") +
          ("FROM_END" === f || "FROM_START" === f ? ", " + a : "") +
          ")";
      }
      return [
        d,
...
`,
  ...
  var JavascriptGenerator$$module$build$src$generators$javascript$javascript_generator = class extends $.CodeGenerator$$module$build$src$core$generator {
      ...
      getAdjusted(
        ...
        c = 0,
        d = !1,
        e = Order$$module$build$src$generators$javascript$javascript_generator.NONE,
      ) {
  ...
  var javascriptGenerator$$module$build$src$generators$javascript =
    ...
    generators$$module$build$src$generators$javascript = Object.assign(
      {},
  ...
  for (const a in generators$$module$build$src$generators$javascript)
    javascriptGenerator$$module$build$src$generators$javascript.forBlock[a] =
      generators$$module$build$src$generators$javascript[a];
