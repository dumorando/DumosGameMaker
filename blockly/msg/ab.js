...
(function (root, factory) {
  ...
  Blockly.Msg["CONTROLS_FOR_TITLE"] =
    "ацикл %1 ала %2 инаркны %3 рҟынӡа ашьаҿа %4";
  ...
  Blockly.Msg["CONTROLS_REPEAT_HELPURL"] =
    "https://ab.wikipedia.org/wiki/Ацикл";
  ...
  Blockly.Msg["LISTS_CREATE_WITH_ITEM_TOOLTIP"] =
    "Иацнаҵоит аелемент ахьӡынҵахьы";
  ...
  Blockly.Msg["LISTS_SPLIT_TEXT_FROM_LIST"] =
    "еизгатәуп атеқст ахьӡынҵа аҟынтәи";
  ...
  Blockly.Msg["LOGIC_COMPARE_HELPURL"] =
    "https://ru.wikipedia.org/wiki/Аиҟарамра";
  ...
  Blockly.Msg["MATH_ARITHMETIC_HELPURL"] =
    "https://ab.wikipedia.org/wiki/Арифметика";
  Blockly.Msg["MATH_ARITHMETIC_TOOLTIP_ADD"] =
    "Иҳанаҭоит ҩ-хыԥхьаӡарак реицҵалыҵ.";
  Blockly.Msg["MATH_ARITHMETIC_TOOLTIP_DIVIDE"] =
    "Иҳанаҭоит ҩ-хыԥхьаӡарак ршалыҵ.";
  Blockly.Msg["MATH_ARITHMETIC_TOOLTIP_MINUS"] =
    "Иҳанаҭоит ҩ-хыԥхьаӡарак реигырхалыҵ.";
  Blockly.Msg["MATH_ARITHMETIC_TOOLTIP_MULTIPLY"] =
    "Иҳанаҭоит ҩ-хыԥхьаӡарак рышьҭыхлыҵ.";
  ...
  Blockly.Msg["MATH_CHANGE_TOOLTIP"] =
    "Иацнаҵоит ахыԥхьаӡара аҽеиҭак '%1' ахь.";
  Blockly.Msg["MATH_CONSTANT_HELPURL"] =
    "https://ab.wikipedia.org/wiki/Аматематикатә_константа";
  Blockly.Msg["MATH_CONSTANT_TOOLTIP"] =
    "Иҳанаҭооит аконстантақәа руак: π (3.141...), e (2.718...), φ (1.618...), sqrt(2) (1.414...), sqrt(½) (0.707...) ма ∞ (аҵыхәаԥҵәарадара).";
  ...
  Blockly.Msg["MATH_MODULO_TOOLTIP"] =
    "Иҳанаҭоит ацәынха ҩ-хыԥхьаӡарак ршараан.";
  Blockly.Msg["MATH_MULTIPLICATION_SYMBOL"] = "×"; // untranslated
  Blockly.Msg["MATH_NUMBER_HELPURL"] =
    "https://ab.wikipedia.org/wiki/Ахыԥхьаӡара";
  ...
  Blockly.Msg["MATH_ONLIST_TOOLTIP_AVERAGE"] =
    "Иҳанаҭоит ахьӡынҵа аҟны ахыԥхьаӡарақәа зегьы рарифметикатә бжьара.";
  Blockly.Msg["MATH_ONLIST_TOOLTIP_MAX"] =
    "Иҳанаҭоит ахьӡынҵа аҟны иреиҳау ахыԥхьаӡара.";
  ...
  Blockly.Msg["MATH_ONLIST_TOOLTIP_MIN"] =
    "Иҳанаҭоит ахьӡынҵа аҟны иреицо ахыԥхьаӡара.";
  ...
  Blockly.Msg["MATH_ONLIST_TOOLTIP_SUM"] =
    "Иҳанаҭоит ахьӡынҵа иаҵанакуа ахыԥхьаӡарақәа зегьы реицҵалыҵ.";
  ...
  Blockly.Msg["MATH_RANDOM_FLOAT_TITLE_RANDOM"] =
    "иарбанзаалакь ахыԥхьашара 0 инаркны (иалаҵаны)  1 аҟынӡа";
  Blockly.Msg["MATH_RANDOM_FLOAT_TOOLTIP"] =
    "Иҳанаҭоит иарбанзаалакь ахыԥхьаӡара 0.0 инаркны (иалаҵаны) 1.0 аҟынӡа.";
  Blockly.Msg["MATH_RANDOM_INT_HELPURL"] =
    "https://en.wikipedia.org/wiki/Random_number_generation"; // untranslated
  Blockly.Msg["MATH_RANDOM_INT_TITLE"] =
    "иарбанзаалакь еибгоу ахыԥхьаӡара %1 инаркны %2 нӡа";
  ...
  Blockly.Msg["MATH_ROUND_HELPURL"] =
    "https://ab.wikipedia.org/wiki/Ахыркәшара";
  ...
  Blockly.Msg["MATH_SINGLE_TOOLTIP_LN"] =
    "Иҳанаҭоит ахыԥхьаӡара иԥсабаратәу алогарифм.";
  Blockly.Msg["MATH_SINGLE_TOOLTIP_LOG10"] =
    "Иҳанаҭоит ахыԥхьаӡара ажәабатә логарифм.";
  Blockly.Msg["MATH_SINGLE_TOOLTIP_NEG"] = "Иҳанаҭоит иаҿагыло ахыԥхьаӡара.";
  Blockly.Msg["MATH_SINGLE_TOOLTIP_POW10"] =
    "Return 10 to the power of a number."; // untranslated
  Blockly.Msg["MATH_SINGLE_TOOLTIP_ROOT"] =
    "Return the square root of a number."; // untranslated
  ...
  Blockly.Msg["MATH_TRIG_HELPURL"] =
    "https://ab.wikipedia.org/wiki/Атригонометриатә_функциа";
  ...
  Blockly.Msg["PROCEDURES_DEFNORETURN_TOOLTIP"] =
    "Иаԥнаҵоит апроцедура, аҵакы ҳазымҭо.";
  ...
  Blockly.Msg["PROCEDURES_DEFRETURN_TOOLTIP"] =
    "Иаԥнаҵоит апроцедура, аҵакы ҳазҭо.";
  ...
  Blockly.Msg["PROCEDURES_IFRETURN_WARNING"] =
    "Агәаҽанҵара: Ари аблок ахархәара ауеит афункциа аԥҵара аҟны.";
  ...
  Blockly.Msg["RENAME_VARIABLE_TITLE"] =
    "Аҽеиҭакқәа'%1' зегь рыхьӡ ԥсахтәуп аҟны:";
  ...
  Blockly.Msg["TEXT_GET_SUBSTRING_TOOLTIP"] =
    "Иҳанаҭоит атеқст аҟны иарбоу ахәҭа.";
  ...
  Blockly.Msg["TEXT_LENGTH_TOOLTIP"] =
    "Иҳанаҭоит асимволқәа рхыԥхьаӡара (абжьажьқәа алаҵаны) иҟоу атеқст аҟны.";
  ...
  Blockly.Msg["TEXT_PRINT_TOOLTIP"] =
    "Иакьыԥхьуеит атеқст, ахыԥхьаӡара ма даҽа обиеқтк.";
  ...
  Blockly.Msg["TEXT_TEXT_HELPURL"] =
    "https://ab.wikipedia.org/wiki/Ацәаҳәатә_хкы";
