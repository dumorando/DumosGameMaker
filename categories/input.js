...
javascript.javascriptGenerator.forBlock['input_keydown'] = function(block, generator) {
  ...
  javascript.javascriptGenerator.forBlock['input_keyreleased'] = function(block, generator) {
    var text_key = block.getFieldValue('KEY');
    // TODO: Assemble javascript into code variable.
  ...
  javascript.javascriptGenerator.forBlock['input_mousedown'] = function(block, generator) {
    var code = 'isMouseDown()';
    // TODO: Change ORDER_NONE to the correct strength.
    return [code, Blockly.JavaScript.ORDER_NONE];
  };

  javascript.javascriptGenerator.forBlock['input_mousepressed'] = function(block, generator) {
    var code = 'isMousePressed()';
    // TODO: Change ORDER_NONE to the correct strength.
    return [code, Blockly.JavaScript.ORDER_NONE];
  };

  javascript.javascriptGenerator.forBlock['input_mousereleased'] = function(block, generator) {
    var code = 'isMouseReleased()';
    // TODO: Change ORDER_NONE to the correct strength.
    return [code, Blockly.JavaScript.ORDER_NONE];
  };

  javascript.javascriptGenerator.forBlock['input_mousepos'] = function(block, generator) {
    // TODO: Assemble javascript into code variable.
