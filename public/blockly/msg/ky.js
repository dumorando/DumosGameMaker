...
(function (root, factory) {
  ...
  Blockly.Msg["COLOUR_BLEND_TOOLTIP"] =
    "Эки түстү берилген катыш (0.0 - 1.0) менен аралаштыр.";
  ...
  Blockly.Msg["COLOUR_RGB_TOOLTIP"] =
    "Кызыл, жашыл жана көк түстөрдөн жаңы түс жаса. Ар бир түстүн мааниси 0 менен 100 арасында болуусу керек.";
  ...
  Blockly.Msg["CONTROLS_FOREACH_TITLE"] =
    "%2 катарынын ар бир элементи %1 үчүн";
  ...
  Blockly.Msg["CONTROLS_FOR_TITLE"] =
    "%1 менен %2 ден %3 кө чейин %4 төн эсепте";
  ...
  Blockly.Msg["CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL"] =
    "Маани ката болгон учурда билдирүүлөрдү кайтала";
  Blockly.Msg["CONTROLS_WHILEUNTIL_TOOLTIP_WHILE"] =
    "Маани туура болгон учурда билдирүүлөрдү кайтала";
  ...
  Blockly.Msg["RENAME_VARIABLE_TITLE"] =
    "Баардык '%1' өзгөрмөнүнүн атын алмаштыр";
