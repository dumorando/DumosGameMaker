...
(function (root, factory) {
  ...
  Blockly.Msg["CONTROLS_IF_ELSEIF_TOOLTIP"] =
    'Adder un condition al bloco "si".';
  ...
  Blockly.Msg["CONTROLS_REPEAT_HELPURL"] =
    "https://ia.wikipedia.org/wiki/Bucla_for";
  ...
  Blockly.Msg["LISTS_GET_SUBLIST_START_FROM_END"] =
    "prender sublista ab № a partir del fin";
  ...
  Blockly.Msg["LISTS_INDEX_OF_FIRST"] =
    "cercar le prime occurrentia del elemento";
  ...
  Blockly.Msg["LISTS_INDEX_OF_LAST"] =
    "cercar le ultime occurrentia del elemento";
  ...
  Blockly.Msg["MATH_ARITHMETIC_TOOLTIP_ADD"] =
    "Retornar le summa del duo numeros.";
  ...
  Blockly.Msg["MATH_ONLIST_TOOLTIP_MEDIAN"] =
    "Retornar le numero median del lista.";
  ...
  Blockly.Msg["MATH_RANDOM_INT_TITLE"] =
    "numero integre aleatori inter %1 e %2";
  ...
  Blockly.Msg["MATH_ROUND_HELPURL"] =
    "https://ia.wikipedia.org/wiki/Rotundamento";
  ...
  Blockly.Msg["PROCEDURES_HIGHLIGHT_DEF"] =
    "Accentuar le definition del function";
  ...
  Blockly.Msg["TEXT_ISEMPTY_TOOLTIP"] =
    "Retorna ver si le texto fornite es vacue.";
  ...
  Blockly.Msg["TEXT_TRIM_OPERATOR_LEFT"] =
    "remover spatios del sinistre latere de";
  Blockly.Msg["TEXT_TRIM_OPERATOR_RIGHT"] =
    "remover spatios del dextre latere de";
