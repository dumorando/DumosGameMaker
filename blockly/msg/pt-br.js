...
(function (root, factory) {
  ...
  Blockly.Msg["COLOUR_PICKER_TOOLTIP"] =
    "Escolher uma cor da palheta de cores.";
  ...
  Blockly.Msg["LISTS_REPEAT_TITLE"] =
    "criar lista com item %1 repetido %2 vezes";
  ...
  Blockly.Msg["LISTS_SPLIT_LIST_FROM_TEXT"] =
    "Fazer uma lista a partir do texto";
  ...
  Blockly.Msg["NEW_STRING_VARIABLE"] =
    "Criar variável de segmentos de texto...";
  ...
  Blockly.Msg["TEXT_CHARAT_TOOLTIP"] =
    "Retorna a letra na posição especificada.";
  ...
  Blockly.Msg["TEXT_TRIM_OPERATOR_BOTH"] =
    "remover espaços de ambos os lados de";
