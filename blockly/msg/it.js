...
(function (root, factory) {
  ...
  Blockly.Msg["CONTROLS_REPEAT_TOOLTIP"] =
    "Esegue alcune istruzione diverse volte.";
  ...
  Blockly.Msg["LISTS_GET_SUBLIST_START_FIRST"] =
    "prendi sotto-lista dall'inizio";
  ...
  Blockly.Msg["LISTS_INDEX_OF_FIRST"] =
    "trova la prima occorrenza dell'elemento";
  ...
  Blockly.Msg["LISTS_INDEX_OF_LAST"] =
    "trova l'ultima occorrenza dell'elemento";
  ...
  Blockly.Msg["LISTS_ISEMPTY_TOOLTIP"] =
    "Restituisce vero se la lista è vuota.";
  ...
  Blockly.Msg["MATH_CHANGE_TOOLTIP"] =
    "Aggiunge un numero alla variabile '%1'.";
  ...
  Blockly.Msg["MATH_ONLIST_OPERATOR_STD_DEV"] =
    "deviazione standard della lista";
  ...
  Blockly.Msg["MATH_TRIG_TOOLTIP_ACOS"] =
    "Restituisce l'arco-coseno di un numero.";
  Blockly.Msg["MATH_TRIG_TOOLTIP_ASIN"] =
    "Restituisce l'arco-seno di un numero.";
  ...
  Blockly.Msg["PROCEDURES_DEFNORETURN_TOOLTIP"] =
    "Crea una funzione senza output.";
  ...
  Blockly.Msg["PROCEDURES_DEFRETURN_TOOLTIP"] =
    "Crea una funzione con un output.";
  ...
  Blockly.Msg["PROCEDURES_MUTATORARG_TOOLTIP"] =
    "Aggiungi un input alla funzione.";
  ...
  Blockly.Msg["TEXT_APPEND_TOOLTIP"] =
    "Aggiunge del testo alla variabile '%1'.";
  ...
  Blockly.Msg["TEXT_INDEXOF_OPERATOR_FIRST"] =
    "trova la prima occorrenza del testo";
  Blockly.Msg["TEXT_INDEXOF_OPERATOR_LAST"] =
    "trova l'ultima occorrenza del testo";
  ...
  Blockly.Msg["TEXT_TEXT_TOOLTIP"] =
    "Una lettera, una parola o una linea di testo.";
  ...
  Blockly.Msg["TEXT_TRIM_OPERATOR_BOTH"] =
    "rimuovi spazi da entrambi gli estremi";
