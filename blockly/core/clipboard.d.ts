 ...
 * @internal
 */
export declare function copy<T extends ICopyData>(
  toCopy: ICopyable<T>,
): T | null;
/**
 * Private version of copy for stubbing in tests.
 */
declare function copyInternal<T extends ICopyData>(
  toCopy: ICopyable<T>,
): T | null;
/**
 ...
 */
export declare function paste<T extends ICopyData>(
  copyData: T,
 ...
 * @internal
 */
export declare function duplicate<
  U extends ICopyData,
 ...
 */
declare function duplicateInternal<
  U extends ICopyData,
  T extends ICopyable<U> & IHasWorkspace,
>(toDuplicate: T): T | null;
