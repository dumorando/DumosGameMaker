 ...
 */
export declare function callbackFactory(
  block: Block,
 ...
 * @internal
 */
export declare function commentDeleteOption(
 ...
 * @internal
 */
export declare function commentDuplicateOption(
  comment: WorkspaceCommentSvg,
): LegacyContextMenuOption;
/**
 ...
 * @internal
 */
export declare function workspaceCommentOption(
  ws: WorkspaceSvg,
  e: Event,
): ContextMenuOption;
