...
(function (root, factory) {
  ...
  Blockly.Msg["CONTROLS_FOR_TITLE"] =
    "μέτρησε με %1 από το %2 έως το %3 ανά %4";
  ...
  Blockly.Msg["CONTROLS_REPEAT_TOOLTIP"] =
    "Εκτελεί κάποιες εντολές αρκετές φορές.";
  ...
  Blockly.Msg["CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL"] =
    "Εφόσον μια τιμή είναι ψευδής, τότε εκτελεί κάποιες εντολές.";
  Blockly.Msg["CONTROLS_WHILEUNTIL_TOOLTIP_WHILE"] =
    "Εφόσον μια τιμή είναι αληθής, τότε εκτελεί κάποιες εντολές.";
  ...
  Blockly.Msg["DELETE_VARIABLE_CONFIRMATION"] =
    "Θέλετε να διαγράψετε το %1 που χρησιμοποιείτε από την μεταβλητή '%2'?";
  ...
  Blockly.Msg["LISTS_INDEX_FROM_END_TOOLTIP"] =
    "Το %1 είναι το τελευταίο στοιχείο.";
  ...
  Blockly.Msg["LISTS_INDEX_OF_LAST"] =
    "βρες την τελευταία εμφάνιση του στοιχείου";
  ...
  Blockly.Msg["LISTS_ISEMPTY_TOOLTIP"] =
    "Επιστρέφει αληθής αν η λίστα είναι κενή.";
  ...
  Blockly.Msg["LISTS_SORT_TYPE_IGNORECASE"] =
    "αλφαβητικά, αγνοήστε το στοιχείο";
  ...
  Blockly.Msg["MATH_ONLIST_TOOLTIP_MEDIAN"] =
    "Επιστρέφει τον διάμεσο της λίστας.";
  ...
  Blockly.Msg["MATH_SINGLE_TOOLTIP_NEG"] =
    "Επιστρέφει την αρνητική ενός αριθμού.";
  ...
  Blockly.Msg["PROCEDURES_DEFNORETURN_COMMENT"] =
    "Περιγράψετε αυτήν την ιδιότητα..";
  ...
  Blockly.Msg["RENAME_VARIABLE_TITLE"] =
    "Μετονόμασε όλες τις μεταβλητές «%1» σε:";
  ...
  Blockly.Msg["TEXT_CHARAT_TOOLTIP"] =
    "Επιστρέφει το γράμμα στην καθορισμένη θέση.";
  ...
  Blockly.Msg["TEXT_PROMPT_TYPE_NUMBER"] =
    "πρότρεψε με μήνυμα για να δοθεί αριθμός";
  Blockly.Msg["TEXT_PROMPT_TYPE_TEXT"] =
    "πρότρεψε με μήνυμα για να δοθεί κείμενο";
  ...
  Blockly.Msg["TEXT_TEXT_TOOLTIP"] =
    "Ένα γράμμα, μια λέξη ή μια γραμμή κειμένου.";
