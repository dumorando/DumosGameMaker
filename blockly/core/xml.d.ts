 ...
 */
export declare function workspaceToDom(
  workspace: Workspace,
  opt_noId?: boolean,
): Element;
/**
 ...
 *     an insertion marker.
 */
export declare function blockToDomWithXY(
  block: Block,
  opt_noId?: boolean,
 ...
 *     an insertion marker.
 */
export declare function blockToDom(
  block: Block,
  opt_noId?: boolean,
): Element | DocumentFragment;
/**
 ...
 */
export declare function clearWorkspaceAndLoadFromXml(
  xml: Element,
 ...
 * @returns An array containing new block IDs.
 */
export declare function domToWorkspace(
  xml: Element,
  workspace: Workspace,
): string[];
/**
 ...
 * @returns An array containing new block IDs.
 */
export declare function appendDomToWorkspace(
  xml: Element,
  workspace: WorkspaceSvg,
): string[];
/**
 ...
 */
export declare function domToBlock(
  xmlBlock: Element,
  workspace: Workspace,
): Block;
/**
 ...
 * @internal
 */
export declare function domToBlockInternal(
  xmlBlock: Element,
  workspace: Workspace,
): Block;
/**
 ...
 */
export declare function domToVariables(
