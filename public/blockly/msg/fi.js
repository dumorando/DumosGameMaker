...
(function (root, factory) {
  ...
  Blockly.Msg["LISTS_GET_SUBLIST_START_FROM_START"] =
    "hae osalista alkaen kohdasta";
  Blockly.Msg["LISTS_GET_SUBLIST_TAIL"] = ""; // untranslated
  Blockly.Msg["LISTS_GET_SUBLIST_TOOLTIP"] =
    "Luo kopio määrätystä kohden listaa.";
  ...
  Blockly.Msg["LISTS_REPEAT_TITLE"] =
    "luo lista, jossa kohde %1 toistuu %2 kertaa";
  ...
  Blockly.Msg["MATH_TRIG_TOOLTIP_SIN"] =
    "Palauttaa asteluvun (ei radiaanin) sinin.";
  ...
  Blockly.Msg["RENAME_VARIABLE_TITLE"] =
    "Nimeä uudelleen muuttuja '%1' kaikkialla:";
  ...
  Blockly.Msg["TEXT_GET_SUBSTRING_TOOLTIP"] =
    "Palauttaa määrätyn osan tekstistä.";
  ...
  Blockly.Msg["TEXT_PROMPT_TOOLTIP_TEXT"] =
    "Kehottaa käyttäjää syöttämään tekstiä.";
  ...
  Blockly.Msg["TEXT_TRIM_OPERATOR_LEFT"] =
    "poistaa välilyönnit vasemmalta puolelta";
  ...
  Blockly.Msg["VARIABLE_ALREADY_EXISTS"] =
    "Muuttuja nimeltään '%1' on jo olemassa.";
